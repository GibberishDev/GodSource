...
func add_command(command_name: StringName, callable: Callable, arguments_number: int = 0, description: String = "NO DESCRIPTION PROVIDED", context : Array[GSInput.INPUT_CONTEXT] = []) -> Command:
