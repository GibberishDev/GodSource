...
func register_convars() -> void:
	...
	GSConsole.add_convar(&"sv_friction", GSConsole.CONVAR_TYPE.FLOAT,[GSConsole.CONVAR_FLAGS.CHEAT], "4.0")
	...
	GSConsole.add_convar(&"host_timescale", GSConsole.CONVAR_TYPE.FLOAT,[GSConsole.CONVAR_FLAGS.CHEAT], "1.0", "0.0")
